  ...
  export default {
    head: {
      ...
      meta: [
        ...
        { hid: 'twitter:site', name: 'twitter:site', content: 'https://jicjjangtest.github.io/blog' },
        { hid: 'twitter:domain', name: 'twitter:domain', content: 'https://jicjjangtest.github.io/blog' },
